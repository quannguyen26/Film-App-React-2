...
const Header = () => {
  ...
  return (
    <div className="my-container relative flex items-center justify-between bg-black py-4">
      ...
      <div
        className={`xs:left-1/2 xs:w-[85%] xs:-translate-x-1/2 absolute top-full left-0 z-50 flex w-full 
          flex-col items-center gap-4 bg-black p-3 transition-all duration-300 sm:hidden opacity-90
          ${isOpen ? "block" : "hidden"}`}
      >
